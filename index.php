...
<body>
    <header>
        <nav class="nav bd-grid">  
            <img src="./assets/images/maggothub.svg" class="logo-maggothub" alt="">
            <div class="nav__logo">
                <h1><a href="index.html"><span>Maggot</span>Hub</a></h1>
            </div>
			<div class="nav__menu" id="nav-menu">
				<ul class="nav__list">
					<a href="#home" class="nav__link active"><li class="nav__item"><strong>Beranda</strong></li></a>
					<a href="produk.html" class="nav__link"><li class="nav__item"><strong>Produk</strong></li></a>
					<a href="index.html#tentang-bsf" class="nav__link"><li class="nav__item"><strong>Tentang BSF</strong></li></a>
				</ul>
			</div>
            <div class="nav__menu" id="nav-menu">
				<ul class="nav__list">
    ...
    <!--Mobile Nav-->
    <div class="mobile-nav">
        <a href="index.html#home" class="nav__link"><strong>Beranda</strong></a>
		<a href="produk.html" class="nav__link"><strong>Produk</strong></a>
        <a href="index.html#tentang-bsf" class="nav__link"><strong>Tentang BSF</strong></a>
        <div class="nav__dropdown">
            <a href="#">
                <strong>Masuk</strong>
                <i class='bx bx-chevron-down nav__icon nav__dropdown-icon'></i>
            ...
            <div class="nav__dropdown-collapse">
                <div class="nav__dropdown-content">
                    <a href="login-penjual.html" class="nav__dropdown-item nav__link">Sebagai Penjual</a>
                    <a href="login-pembeli.html" class="nav__dropdown-item nav__link">Sebagai Pembeli</a>
                </div>
            </div>
        </div>
        <div class="nav__dropdown">
            ...
            <div class="nav__dropdown-collapse">
                <div class="nav__dropdown-content">
                    <a href="register-penjual.html" class="nav__dropdown-item nav__link">Sebagai Penjual</a>
                    <a href="register-pembeli.html" class="nav__dropdown-item nav__link">Sebagai Pembeli</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-3 fix-img">
                <div class="produk">
                    ...
                    <div class="harga">
                        ...
                        <p>Rp25.000</p>
                        <hr>
                        <a href="detail-produk.html"><button>Lihat Produk</button></a>
                    </div>
                </div>
            </div>
        </div>
        <a href="produk.html"><button>Lihat Selengkapnya</button></a>
    </div>
    ...
    <div class="modal-container" id="modal-masuk">
        <div class="modal">
            ...
            <h2>Pilih Daftar sebagai Penjual atau Pembeli</h2>
            <div class="card">
                <a href="login-penjual.html" class="kiri">
                    <div>
                        <img src="assets/images/ic-penjual.svg" alt="">
                        <h1>Penjual</h1>
                    </div>
    ...
    <div class="modal-container" id="modal-daftar">
        <div class="modal">
            ...
            <h2>Pilih Daftar sebagai Penjual atau Pembeli</h2>
            <div class="card">
                <a href="register-penjual.html" class="kiri">                        
                <div>
                    <img src="assets/images/ic-penjual.svg" alt="">
                    <h1>Penjual</h1>
                </div>
