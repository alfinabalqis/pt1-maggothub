...
<body>
    <header>
        <nav class="nav bd-grid">  
            <img src="./assets/images/maggothub.svg" class="logo-maggothub" alt="">
            <div class="nav__logo">
                <h1><a href=""><span>Maggot</span>Hub</a></h1>
            </div>
			<div class="nav__menu" id="nav-menu">
				<ul class="nav__list">
					<a href="index.html" class="nav__link" id="beranda"><li class="nav__item"><strong>Beranda</strong></li></a>
					<a href="produk.html" class="nav__link"><li class="nav__item">Produk</li></a>
					<a href="#tentang-bsf" class="nav__link"><li class="nav__item">Tentang BSF</li></a>
				</ul>
			</div>
            <div class="nav__menu" id="nav-menu">
				<ul class="nav__list">
            ...
            <div class="col-3 fix-img">
                <div class="produk">
                    <div class="img-produk">
                        ...
                        <img src="assets/images/biomagg.png" alt="Foto Produk">
                    </div>
                    <h3>Biomagg Maggfeed </h3>
                    <span><img src="assets/images/rating.png" alt="">4.5</span>
                    <hr>
            ...
            <div class="col-3 fix-img">
                <div class="produk">
                    <div class="img-produk">
                        ...
                        <img src="assets/images/tepung.png" alt="Foto Produk">
                    </div>
                    <h3>Tepung Maggot BSF</h3>
                    <span><img src="assets/images/rating.png" alt="">4.5</span>
                    <hr>
            ...
            <div class="col-3 fix-img">
                <div class="produk">
                    <div class="img-produk">
                        ...
                        <img src="assets/images/super-magot.png" alt="Foto Produk">
                    </div>
                    <h3>SUPER MAGGOT Kering</h3>
                    <span><img src="assets/images/rating.png" alt="">4.5</span>
                    <hr>
        ...
        <div class="container">
            <div class="row">
                <div style="max-width: 25%">
                    <img src="assets/images/logo.png" alt="">
                    <p>MaggotHub berkeinginan meyebarluaskan perkembangan produk maggot sekaligus memperluas pasar penjualan maggot.</p>
                </div>
                <div class="footer-list" style="display: flex;">
                    <div>
                        <h5>Kontak Kami</h5>
            ...
            <p class="copyright">&#x24B8; Copyright 2022 Altruis Team</p>
        </div>
    </footer>
...
>>>>>>> 365b2a2... fix styiling:index.html
</html>