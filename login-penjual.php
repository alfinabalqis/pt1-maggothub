    ...
    <div class="register-form col-md-6">
      ...
      <div class="register">
        <div class="title mt-5">
          <h2>Welcome Back</h2>
          <h3>Promosikan Produk Anda <br>Dengan Mudah</h3>
      </div>
      <div class="register mt-5">
          ...
          <div class="akun mt-3">
            <p>Belum Memiliki akun? <a href="register-penjual.php">Register</a></p>
          </div>
      </div>
      </div>
    </div>
  ...
  <div class="register-content">
    <div class="register-form col-md-6">
      ...
      <div class="register mt-5">
          ...
          <div class="akun mt-3">
            <p>Belum Memiliki akun? <a href="register-penjual.html">Register</a></p>
          </div>
      </div>
      </div>
    </div>
