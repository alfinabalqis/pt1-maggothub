...
if(!empty($_SESSION['msg2'])) {
   echo "<script>
            alert('Akun penjual baru berhasil ditambahkan');
        </script>";
} else {
  $_SESSION['email'] = '';
  $_SESSION['pass'] = '';
    ...
    <p class="back2home">&#8249; <a href="index.php">Beranda</a>
      ...
      <div class="register">
        <div class="title mt-5" style="text-align: justify;">
          ...
          <h3>Promosikan produk Maggot BSF anda dengan mudah</h3>
      </div>
      ...
      <form action="" method="post">
        ...
        <div class="form-group form-outline flex-fill mb-3">
          <input type="password" class="form-control" id="password" name="password" value="<?= $_SESSION['pass'] ?>" required>
        ...
        <div class="btn-register">
          ...
          <div class="akun ml-0 mt-3">
            <p>Belum memiliki akun? <a href="register-penjual.php">Daftar</a> di sini</p>
          </div>
      </div>
      </div>
    </div>
